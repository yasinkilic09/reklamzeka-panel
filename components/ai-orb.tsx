    ...
    <div className="relative overflow-hidden rounded-[2rem] border border-cyan-300/10 bg-white/[0.045] p-5 shadow-2xl shadow-cyan-950/30 backdrop-blur-2xl">
      ...
      <div className="relative mb-4 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-xs leading-5 text-slate-400">
            Kampanya üretimi, görsel brief, müşteri mesajı ve performans
            analizini tek akılda birleştirir.
          </p>
        </div>
      ...
      <div className="relative rounded-2xl border border-white/10 bg-slate-950/45 p-4">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-300">
          İşletme verilerini okuyup reklamdan müşteriye giden en doğru aksiyon
          akışını önermek.
        </p>
      </div>
      ...
      <div className="relative mt-4 grid grid-cols-3 gap-3">
        <div className="rounded-2xl border border-cyan-300/10 bg-cyan-300/[0.055] p-3 text-center">
          ...
          <p className="mt-2 text-sm font-black text-cyan-200">Strateji</p>
        </div>
        ...
        <div className="rounded-2xl border border-purple-300/10 bg-purple-300/[0.055] p-3 text-center">
          ...
          <p className="mt-2 text-sm font-black text-purple-200">Yaratıcı</p>
        </div>
        ...
        <div className="rounded-2xl border border-emerald-300/10 bg-emerald-300/[0.055] p-3 text-center">
          ...
          <p className="mt-2 text-sm font-black text-emerald-200">Dönüşüm</p>
        </div>
      </div>
    </div>
  );
